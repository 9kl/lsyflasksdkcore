...
from lsyflasksdkcore.swagger.doc import SwaggerDoc
...
def generate_swagger_ui(
    app, config_path="./swagger.json", url_prefix="/api/doc", title="API doc"
):
...
def generate_swagger_file(
    ...
    title="Linkeddt API",
    version="1.0.0",
    description="Documentation for the Linkeddt API",
):
    spec = APISpec(
        title=title,
        version=version,
