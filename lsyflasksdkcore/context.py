...
from lsyflasksdkcore.serialization import Serialization, SerializationError
...
def expire_eresponse(message, **kwargs):
    """expire response"""
    d = {"code": 403, "message": message, "data": None, "error": True}
    d.update(kwargs)
    return jsonify(d)
